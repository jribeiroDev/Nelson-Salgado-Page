...
const PricingSection = () => (
  ...
  >
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex grid-cols-1 md:grid-cols-3 gap-8 pt-6">
        {/* Card 1 MÊS - Básico */}
        ...
        <Card className="p-8 bg-gradient-to-br cursor-pointer from-blue to-darkblue text-beige border-0 relative overflow-visible shadow-2xl transform scale-105 hover:scale-110 transition-all duration-300">
          <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-20">
            <Badge className="bg-gold text-white font-medium border-0 shadow-lg px-4 py-2 rounded-full">
