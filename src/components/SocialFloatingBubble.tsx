          ...
          <>
            ...
            >
              ...
              >
                ...
                {/* Mobile: Botão com texto integrado */}
                <motion.button
                  onClick={openWhatsApp}
                  className="flex items-center justify-center gap-2 sm:gap-0 bg-gradient-to-r from-green-400 to-green-500 rounded-full px-3 py-2 sm:p-0 sm:w-12 sm:h-12 lg:w-14 lg:h-14 shadow-lg text-white hover:shadow-xl transition-all duration-300 hover:scale-110 group"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  <WhatsAppIcon className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 group-hover:scale-110 transition-transform flex-shrink-0" />
                  <span className="text-xs font-medium sm:hidden whitespace-nowrap">
                    WhatsApp
                  </span>
                </motion.button>
              </motion.div>
              ...
              >
                ...
                <motion.button
                  ...
                  className="flex items-center justify-center gap-2 sm:gap-0 bg-blue rounded-full px-3 py-2 sm:p-0 sm:w-12 sm:h-12 lg:w-14 lg:h-14 shadow-lg text-beige hover:shadow-xl transition-all duration-300 hover:scale-110 group"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  <InstagramIcon className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 group-hover:scale-110 transition-transform flex-shrink-0" />
                  <span className="text-xs font-medium sm:hidden whitespace-nowrap">
                    Instagram
                  </span>
                </motion.button>
